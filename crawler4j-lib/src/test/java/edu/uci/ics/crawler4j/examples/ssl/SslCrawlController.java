...
package edu.uci.ics.crawler4j.examples.ssl;
 ...
 */
public class SslCrawlController {
...
//		}
        ...
        // TODO - set the key store path to a valid PKCS12 file
        config.setKeyStorePath("");
        config.setKeyStorePass("ravnravn");
        config.setKeyPass("ravnravn");
		...
		controller.addSeed("https://storage.sandbox.deluxemt.net/origin/media/");
		 ...
		 */
		controller.start(SslCrawler.class, numberOfCrawlers);
	}
}
