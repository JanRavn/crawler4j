...
package edu.uci.ics.crawler4j.examples.ntlm;
 ...
 */
public class NTLMProxyCrawler extends WebCrawler {
    protected static final Logger logger = LoggerFactory.getLogger(NTLMProxyCrawler.class);
